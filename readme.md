# Proyecto Final: Análisis de Datos de Taxis en Nueva York en temporada de verano

## Descripción
Este proyecto final del bootcamp de Data Analyst Jr. tiene como objetivo poner en práctica las habilidades y conocimientos adquiridos durante el curso. Se utilizan datos reales de taxis en la ciudad de Nueva York para realizar un análisis completo, desde la recopilación y almacenamiento de datos hasta la extracción de insights y presentación de los mismos.
